...
<head>
    ...
    <script type="text/javascript">
        ...
        function changePageSize(select) {
            var page = $(select).val();
            location.href = "${pageContext.request.contextPath}/dept_list/1/" + page;
        }
        ...
        function changePage() {
            ...
            location.href = "${pageContext.request.contextPath}/dept_list/" + page + "/${pageUtil.pageSize}";
        }
    </script>
</head>
<body>
<div class="layui-container">
        ...
        <c:forEach items="${pageUtil.records}" var="dept">
            <tr>
                ...
                <td><a class="layui-btn layui-btn-mini" href="departupdate.html">编辑</a>
                    <a class="layui-btn layui-btn-danger layui-btn-mini" onclick="deleteDept(${dept.id})">删除</a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
    <div class="layui-box layui-laypage layui-laypage-default" id="layui-laypage-1">
        ...
        <c:if test="${pageUtil.pageIndex!=1}">
            <a href="${pageContext.request.contextPath}/dept_list/${pageUtil.pageIndex-1}/${pageUtil.pageSize}"
        ...
        <c:forEach begin="${pageUtil.numberStart}" end="${pageUtil.numberEnd}" var="num" step="1">
            ...
            <c:if test="${pageUtil.pageIndex!=num}">
                <a href="${pageContext.request.contextPath}/dept_list/${num}/${pageUtil.pageSize}">${num}</a>
            </c:if>
        </c:forEach>
    ...
    function deleteDept(id) {
        layui.use('table', function () {
            layer.confirm('是否确认删除部门?', function (index) {
                ...
                $.get("${pageContext.request.contextPath}/del_dept", {"id": id}, function (result) {
