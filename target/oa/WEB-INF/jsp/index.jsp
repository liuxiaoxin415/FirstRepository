...
<head>
    ...
    <script type="text/javascript">
        function logout() {
            if (confirm("确定要退出吗？")) {
                location.href = "${pageContext.request.contextPath}/emp_logout"
            }
        }
    </script>
</head>
    ...
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item">
                <a href="javascript:;">
                    <img src="${pageContext.request.contextPath}/media/upload/${sessionScope.empLogin.photo}"
                         class="layui-nav-img">
                    ${sessionScope.empLogin.name}
                </a>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="lm">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'page_clock','我的日历')">&nbsp;&nbsp;&nbsp;&nbsp;我的日历</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(2,'page_weather','天气查询')">&nbsp;&nbsp;&nbsp;&nbsp;天气查询</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(3,'page_map','地图查询')">&nbsp;&nbsp;&nbsp;&nbsp;地图查询</a>
                        </dd>
                    </dl>
                </li>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'dept_list/1/3','部门列表')">&nbsp;&nbsp;&nbsp;&nbsp;部门列表</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'page_departadd','部门新增')">&nbsp;&nbsp;&nbsp;&nbsp;部门新增</a>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'emp_list/1/1','员工列表')">&nbsp;&nbsp;&nbsp;&nbsp;员工列表</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'page_empadd','员工新增')">&nbsp;&nbsp;&nbsp;&nbsp;员工新增</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'getTongJiData','员工统计')">&nbsp;&nbsp;&nbsp;&nbsp;员工统计</a>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'courselist.html','专业列表')">&nbsp;&nbsp;&nbsp;&nbsp;专业列表</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(2,'courseadd.html','专业新增')">&nbsp;&nbsp;&nbsp;&nbsp;专业新增</a>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'gradelist.html','班级列表')">&nbsp;&nbsp;&nbsp;&nbsp;班级列表</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(2,'gradeadd.html','班级新增')">&nbsp;&nbsp;&nbsp;&nbsp;班级新增</a>
                        </dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'student_list/1/3','学生列表')">&nbsp;&nbsp;&nbsp;&nbsp;学生列表</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(2,'studentadd.html','学生新增')">&nbsp;&nbsp;&nbsp;&nbsp;学生新增</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(3,'page_studentbatch','学生导入')">&nbsp;&nbsp;&nbsp;&nbsp;学生导入</a>
                        </dd>
                    </dl>
                </li>
